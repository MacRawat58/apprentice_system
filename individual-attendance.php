            ...
            <div class="side-2" style="overflow-y:scroll">
                <div class="attendance-option">
                    <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
                        <label for="search_req">Enter Name/Apprentice No/Punch ID: </label>
                        
                        <input type="text" name="search_req">
                    ...
                    <table width="100%" border="1" cellpadding="1" cellspacing="0" style="text-align:center; ">
                        ...
                        <tbody>
                          ...
                          if (isset($_POST['view_records'])) {
                            ...
                            $search_query = $_POST['search_req'];
                            $sql_search = "Select * from attendance_records where apprentice_no = '{$search_query}' OR name like '{$search_query}%' OR punch_id= '{$search_query}' Order by date desc";
                            $result = mysqli_query($conn, $sql_search) or die("Query failed");
